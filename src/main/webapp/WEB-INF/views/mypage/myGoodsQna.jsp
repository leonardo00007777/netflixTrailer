        ...
        <div class="local-top">
          ...
          <div class="h-row">
            <div class="h-col h-tit">
              <h1 class="page-tit text-center">나의 상품 문의 내역</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <main class="main-container" id="main-container">
      <div class="main-content" id="main-content">
        <article>
          ...
          <section class="el-container">
            <a href="WN_PB_MO_MYP_040203.html" class="my-qna-tit-container">
              <div class="detail">
                <div class="prd-tit">달콤한 망고를 그대로 얼린 프리미엄 디저트 망고스틱</div>
