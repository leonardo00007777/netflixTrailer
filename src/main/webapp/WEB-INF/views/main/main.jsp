                    ...
                    <div class="swiper-slide">
                     <article class="prd-item">
                       <div class="img-container">
                         <a href="javascript:void(0)" onclick="itemDetail('${newProdList.gdcd}', '${newProdList.odtype}', '${newProdList.odtype2}', '${newProdList.div1}', '${newProdList.mgdimg1}', '${newProdList.gdname}')" class="prd-item-img">
                       ...
                       <div class="detail">
                         <a href="javascript:void(0)" onclick="itemDetail('${newProdList.gdcd}', '${newProdList.odtype}', '${newProdList.odtype2}', '${newProdList.div1}', '${newProdList.mgdimg1}', '${newProdList.gdname}')">
