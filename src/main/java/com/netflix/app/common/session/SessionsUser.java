package com.netflix.app.common.session;

import com.netflix.app.common.util.StringUtil;
import com.netflix.app.model.common.User;
import com.netflix.app.model.common.User.ROLEUSER;
...
public class SessionsUser {
    ...
    */
    ...
    public static Map<String, Object> getSessionUserValue(HttpServletRequest request)
    {
        try
        {
            return (Map<String, Object>)request.getSession().getAttribute("USER_SESSION_INFO");
        }
        catch (Exception e)
        {
